...
<template>
  <!--默认暴露的Vue组件js代码-->
  <!--横向商品滑屏-->
  <div class="swiper-wrapper-food-container swiper-wrapper-food-container-B">
    <div class="swiper-wrapper-food">
      <div class="swiper-slide-food" v-for="(popularItem,index) in homeData.popularItemList ">
        ...
        <div class="swiperDoc ellipsis">
          {{popularItem.simpleDesc}}
        </div>
        <div class="swiperPrice">￥{{popularItem.retailPrice}}</div>
      </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      _initScroll(){
        //商品横向滑屏
        new BScroll('.swiper-wrapper-food-container-B',{
          scrollX: true, // 水平滑动
